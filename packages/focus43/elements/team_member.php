...
?>
    ...
    <div class="span4  <?php echo $name; ?>">
        ...
        <div class='peeps-deets'>
            <a class='email diyIcon modalize' href='#contact-modal' data-url="<?php echo F43_PACKAGE_TOOLS; ?>modals/contact_us?send_to=<?php echo $name; ?>@focus-43.com" data-width="550" ></a>
